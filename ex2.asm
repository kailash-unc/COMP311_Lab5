...
main:
  ...
  add	$8, $0, $v0			# copy the width into $8
				...
				# Condition
  beq	$8, $0, exit			#Branch to 'exit:' section if width is 0
  ...
  syscall           			# print the string
  				...
  				# Calculate perimeter
  add $11, $8, $8			# adds both sides of the width
  add $12, $9, $9			# adds both sides of the height 
  add $13, $11, $12			# adds up the total, which is the perimeter
  ...
  addi 	$v0, $0, 1  			# system call 1 is for printing an integer
  add 	$a0, $0, $13 			# bring the area value from $13 into $a0
  syscall           			# print the integer
  ...
  syscall           			# print the string
				...
				#Store values
  sw $8, width				#updates width
  sw $9, height				#updates height
  sw $10, area				#updates area
  sw $13, perimeter			#updates perimeter

				#Jump
  j  main				#Goes to the start of main section to prompt another find area/perimeter
